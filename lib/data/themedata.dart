...
final NitnemTheme defaultTheme = NitnemTheme(ThemeName.Default, buildLightTheme());
final NitnemTheme starsTheme = NitnemTheme(ThemeName.Stars, buildDarkTheme());
final NitnemTheme forestTheme = NitnemTheme(ThemeName.Forest, buildForestTheme());
final NitnemTheme ethnicTheme = NitnemTheme(ThemeName.Ethnic, buildEthnicTheme());
final NitnemTheme floralTheme = NitnemTheme(ThemeName.Floral, buildFloralTheme());
